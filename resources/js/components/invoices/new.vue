   ...
   const getproducts = async () => {
    ...
    const SubTotal = () => {
        ...
        listCart.value.map((data) => {
            // Certifique-se de que data.quantity é definido, caso contrário, use 0
            const quantity = data.quantity || 0;
            total = total + quantity * data.unit_price;
        });
 ...
 <div class="container">
     <div class="invoices">
        ...
        <div class="card__header">
            <div>
                <h2 class="invoice__title">Nova Nota</h2>
            </div>
            <div>
        ...
        <div class="card__content">
            <div class="card__content--header">
                ...
                <div>
                    ...
                    <p class="my-1">Data Pagamento</p> 
                    <input id="due_date" type="date" class="input" v-model="form.due_date">
                </div>
                <div>
                    <p class="my-1">Número</p> 
                    <input type="text" class="input" v-model="form.number"> 
                    <p class="my-1">Referência (Opcional)</p> 
            ...
            <div class="table">
                ...
                <div class="table--items2" v-for="(itemcart, i) in listCart" :key="itemcart.id">
                    ...
                    <p v-if="itemcart.quantity">
                        R$ {{(itemcart.quantity)*(itemcart.unit_price)}}
                    </p>
                    <p v-else></p>
    ...
    <div class="modal main__modal " :class="{ show: showModal }">
        <div class="modal__content">
            ...
            <h3 class="modal__title">Adicionar Item</h3>
            <hr><br>
            ...
            <div class="model__footer">
                ...
                <!-- <button class="btn btn-light btn__close--modal ">Salvar</button> -->
            </div>
        </div>
    </div>
