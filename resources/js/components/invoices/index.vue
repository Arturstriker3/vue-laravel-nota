  ...
  <div class="container">
      <div class="invoices">
        ...
        <div class="card__header">
            <div>
                <h2 class="invoice__title">Compras</h2>
                <a href="http://127.0.0.1:8000/swagger/documentation#/">API Doc</a>
            </div>
            <div>
        ...
        <div class="table card__content">
            ...
            <div class="table--search">
                ...
                <div class="relative">
                    ...
                    <input class="table--search--input" type="text" placeholder="Procurar Nota"
